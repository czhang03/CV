...
\extrainfo{\faFile{}~\href{https://cdn.jsdelivr.net/gh/chantisnake/CV@master/CV.pdf}{curriculum vitae}}
...
With recent work, it is shown that commutative hypothesis is also crucial
in the foundation of relational verifications. 
Unfortunately there are several difficulties to reason about Kleene Algebra with 
commutative hypothesis, 
one of which is the fact that the equalities in the language model is undecidable.
In this work, we took on this long standing open problem,
hope to uncover more properties of Kleene Algebra with Commutative Hypothesis.}
...
give rise to a method to identify the probabilities of encountering bugs in programs.}
